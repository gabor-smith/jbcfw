...
*/
  char printChar(char xpos, char ypos, unsigned char c);
  char printStr(char xpos, char ypos, const char *str);

  char charWidth(uint8_t _ch, bool last=true);
  char strWidth(const char *txt);
